...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__gamelobby_gamelobby_component__ = __webpack_require__("../../../../../src/app/gamelobby/gamelobby.component.ts");
...
var routes = [
    ...
    { path: 'lobby', component: __WEBPACK_IMPORTED_MODULE_12__gamelobby_gamelobby_component__["a" /* GamelobbyComponent */] },
    { path: 'game', component: __WEBPACK_IMPORTED_MODULE_13__game_game_component__["a" /* GameComponent */] },
    { path: 'register', component: __WEBPACK_IMPORTED_MODULE_14__register_register_component__["a" /* RegisterComponent */] },
    { path: 'management', component: __WEBPACK_IMPORTED_MODULE_15__management_management_component__["a" /* ManagementComponent */] }
];
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_12__gamelobby_gamelobby_component__["a" /* GamelobbyComponent */],
                __WEBPACK_IMPORTED_MODULE_13__game_game_component__["a" /* GameComponent */],
...
var ManagementComponent = /** @class */ (function () {
    ...
    ManagementComponent.prototype.ngOnInit = function () {
        ...
        this.multiplayer.updatedMyCharacters().subscribe(function (data) {
            _this.userCharacters = data;
        });
        this.multiplayer.deletedUserCharacter().subscribe(function (data) {
            _this.userCharacters = data;
        });
        this.multiplayer.oeprationMessage().subscribe(function (data) {
            _this.modalText = data;
            $('#exampleModalCenter').modal();
        });
        this.multiplayer.changedUserPassword().subscribe(function (data) {
            _this.modalText = data;
            $('#exampleModalCenter').modal();
        });
        this.multiplayer.changedUserUsername().subscribe(function (data) {
        });
    };
    ...
    ManagementComponent.prototype.deleteUserCharacter = function (charName) {
        this.multiplayer.deleteUserCharacter(charName);
    };
    ManagementComponent.prototype.changeUserPassword = function () {
        this.multiplayer.changeUserPassword(this.inputCurrentPassword, this.inputPassword1);
    };
    ManagementComponent.prototype.changeUserUsername = function () {
    ...
    //   })
    // }
    ManagementComponent.prototype.testPost = function () {
        this.multiplayer.testPost().subscribe(function (data) {
            console.log(data);
        });
    };
...
var MultiplayerserviceService = /** @class */ (function () {
    function MultiplayerserviceService(router, http) {
        var _this = this;
        this.router = router;
        this.http = http;
        ...
        this.updatedMyCharacters = function () {
            return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].create(function (observer) {
                _this.socket.on('updated-user-characters', function (data) {
                    observer.next(data);
                });
            });
        };
        this.deletedUserCharacter = function () {
            return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].create(function (observer) {
                _this.socket.on('deleted-user-character', function (data) {
                    observer.next(data);
                });
            });
        };
        this.changedUserPassword = function () {
            return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].create(function (observer) {
                _this.socket.on('changed-user-password', function (data) {
                    observer.next(data);
                });
            });
        };
        this.changedUserUsername = function () {
            return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].create(function (observer) {
                _this.socket.on('changed-user-username', function (data) {
                    observer.next(data);
                    _this.user = data.newName;
                });
            });
        };
        this.oeprationMessage = function () {
            return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].create(function (observer) {
                _this.socket.on('operation-message', function (data) {
                    observer.next(data);
                });
            });
        };
    ...
    MultiplayerserviceService.prototype.deleteUserCharacter = function (charName) {
        this.socket.emit('delete-user-character', charName);
    };
    MultiplayerserviceService.prototype.changeUserPassword = function (oldPass, newPass) {
        this.socket.emit('change-user-password', oldPass, newPass);
    };
    MultiplayerserviceService.prototype.changeUserUsername = function (username, password, newUsername) {
        this.socket.emit('change-user-username', username, password, newUsername);
    };
    MultiplayerserviceService.prototype.testPost = function () {
        var datos = 'abc';
        return this.http.post('/test', datos);
    };
    ...
    MultiplayerserviceService = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* Router */], __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["a" /* HttpClient */]])
